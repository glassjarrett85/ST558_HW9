...
bag_best <- select_best(bag_fit, metric="mn_log_loss")
bag_best

# Fit the entire training set on this tuning parameter
bag_final_fit <- bag_wkfl |>
  finalize_workflow(bag_best) |>
  last_fit(bike_split, metrics=metric_set(accuracy, mn_log_loss))

# Then to run this on the test set?
